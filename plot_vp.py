...
filename = 'logfile_vp.csv'  # Replace with the path to your log file
data = pd.read_csv(filename)


# Define the time range for plotting
start_time = 100.00  # Replace with the start time of your desired range
end_time = 260.30    # Replace with the end time of your desired range
...
start_time = 30.00  # Replace with the start time of your desired range
end_time = 150.30    # Replace with the end time of your desired range
# Filter the data based on the time range
